        ...
        $(function(){
            $("#save").click(function () {
                ...
                if(self.leave_type_id=="")
                {
                    ...
                    window.location.href = "../AllocationRequests";
                    self.submit();
                }

            });
            self.btnlinks.discardbtnlink = "/employees/AllocationRequests";
            $("#one").click(function () {
