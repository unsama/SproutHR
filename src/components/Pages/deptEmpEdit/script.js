...
export default{
    created: function () {
        ...
        self.select();
       // self.select1();
        self.btnlinks.discardbtnlink = "/Employees/DeptEmpShow/"+self.$route.params.id;
        $(function () {
            ...
            $("#save").click(function () {
                ...
                {
                    self.submit();
                    window.location.href = "/Employees/DeptEmpShow/"+self.$route.params.id;
    ...
    methods: {
        ...
        select: function () {
            ...
            self.$http.post("/Employees/selectemployeeinfoNotforForm", {"id": self.$route.params.id}).then(function (res) {
                ...
                self.$http.post("/Employees/countDeptEmployees", {"id": self.departmentId}).then(function (res) {
                    var parentdata = res.body.data[0];
        ...
        nextsubmit: function () {
            var self = this;
            self.$http.post("/Employees/selectEmployeeInfoForDeptEmpFormNext", {"id": self.$route.params.id,"deptID":self.departmentId}).then(function (res) {
                var parentdata = res.body.data[0];
                self.employeeName = parentdata.employeename;
