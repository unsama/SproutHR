...
export default{
    created: function () {
        ...
        self.btnlinks.duplicatebtnlink ="/leaves/Deparment_leave_duplicate/"+self.$route.params.id
        $(function () {
            ...
            self.btnlinks.editbtnlink ="/leaves/Department_leave_edit/"+self.$route.params.id
        })
    },
    data () {
        return {
            ...
            counter: 1,
            btnlinks: {
                createbtnlink:"/leaves/Department_leave_create",
                editbtnlink:"",
                deletedropbtnlink:"",
                duplicatebtnlink:"",
