...
export default{
    created: function () {
        ...
        $(function () {
            ...
            self.btnlinks.discardbtnlink = "/recruitment/jobemployee/"+self.$route.params.id;
            $("#save").click(function () {
                self.submit();
                window.location.href = "/recruitment/jobemployee/"+self.$route.params.id;;
            ...
            // $("#save").click(function () {
            //     var r = confirm("Are you sure you want to  duplicate the employee ");
            //     if (r)
            //     {
            //         self.submit();
