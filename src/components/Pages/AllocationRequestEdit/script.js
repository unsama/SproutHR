...
export default{
        ...
        $(function(){
            ...
            $("#save").click(function () {
                if(self.leave_type_id=="")
                {
                    ...
                    window.location.href = "../AllocationRequestShow/"+self.$route.params.id;
                    self.submit();
                }

            });
            self.btnlinks.discardbtnlink = "/Employees/AllocationRequestShow/"+self.$route.params.id;
    ...
    data () {
        return {
            ...
            btnlinks: {
                savebtnlink:"",
                discardbtnlink:"/Employees/Department_leave_select",
            },
            tableheader: [
                "Reference",
