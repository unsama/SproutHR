...
export default{
    created: function () {
        ...
        $(function() {
            ...
            $("#save").click(function () {
                var r = confirm("Are you sure you want to  Duplicate New  Attendance");
                if (r)
                {
    ...
    data () {
        return {
            ...
            btnlinks: {
                ...
                discardbtnlink: "/attendance/manageattendence",
    ...
    methods: {
        select22: function () {
            var self = this;
            self.$http.post("/recruitment/selectatt", {"date": self.$route.params.date,"id": self.$route.params.id}).then(function (res) {
