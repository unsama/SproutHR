    ...
    methods: {
        ...
        select: function () {
            ...
            self.$http.post("/Employees/selectcontractinfo", {"id": self.$route.params.id}).then(function (res) {
                ...
                console.log("parentdata.job_tittle  :"+parentdata.job_tittle);
                console.log("parentdata.department_id:::::: "+parentdata.department_id);
                ...
                console.log("anamolous behavious :: self.contractType_id :: "+self.contractType_id);
                ...
                // self.$http.post("/Employees/selectmanager", {"id":self.employeeId}).then(function (res) {
                //     var dept = res.body.data[0];
                //     self.employeeId = dept.employeename;
                //     console.log(dept.employeename);
                //
                // self.$http.post("/Employees/selectdepartment", {"id":parentdata.department_id}).then(function (res) {
                //     var dept = res.body.data[0];
                //     self.departmentId = dept.name;
                //     console.log("self.departmentId::::::::  "+self.departmentId);
                //
                // self.$http.post("/Employees/selectcontractype", {"id":self.contractType_id}).then(function (res) {
                //     var dept = res.body.data[0];
                //     self.contractType_id = dept.name;
                //     console.log("self.contractType_id :   "+dept.name);
                // self.$http.post("/Employees/fetchContactStatus", {"id":self.status_name}).then(function (res) {
                //     var datas = res.body.data[0];
                //     self.status_name = datas.name;
                // self.$http.post("/Employees/selectworkschedule", {"id":self.work_schedule_id}).then(function (res) {
                //     var dept = res.body.data[0];
                //     self.work_schedule_id = dept.name;
