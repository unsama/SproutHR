...
export default{
    created: function () {
        ...
        $(function () {
            ...
            self.btnlinks.editbtnlink ="/recruitment/ReqSettingEdit/"+self.$route.params.id
            ...
            $(".Duplicate").click(function () {
                self.btnlinks.duplicatebtnlink ="/recruitment/jobpositionduplicate/"+self.$route.params.id
            });
            $("#hide").click(function(){
                $("#hide").hide();
            });
...
//             });
//             $(".Duplicate").click(function () {
//                 var r = confirm("Are you sure you want to duplicate the job");
//                 if (r)
//                 {
//                     window.location.href = "/recruitment/ReqPosition";
//                     self.dsubmit();
