    ...
    created: function () {
        ...
        $(function () {
            ...
            $(".Duplicate").click(function () {
                self.btnlinks.duplicatebtnlink ="/Employees/DuplicateLeaveRequest/"+self.$route.params.id
            });
            ...
            self.btnlinks.editbtnlink ="/Employees/EditLeaveRequest/"+self.$route.params.id
        })
