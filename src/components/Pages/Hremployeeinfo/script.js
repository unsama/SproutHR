...
export default{
    created: function () {
        ...
        self.btnlinks.editbtnlink = "/recruitment/Hremployeeedit/"+self.$route.params.id;
        self.btnlinks.duplicatebtnlink = "/recruitment/hremployeeduplicate/"+self.$route.params.id;
        self.btnlinks.printBadgebtnlink = "/recruitment/PrintBadge/"+self.$route.params.id;
        self.btnlinks.subordinatebtnlink = "/recruitment/hierarchy/"+self.$route.params.id;
        $(function(){
            $("#reds").hide();
            //$("#green").hide();
