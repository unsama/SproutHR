...
export default{
    created: function () {
        ...
        $(function(){
            ...
            self.btnlinks.editbtnlink ="/Employees/Contractone/"+self.$route.params.id;
            self.btnlinks.savebtnlink ="/Employees/Contractone/"+self.$route.params.id;
        });
    ...
    data(){
        return {
            ...
            btnlinks: {
                ...
                discardbtnlink: "/Employees/Contractone",
                savebtnlink:"/Employees/Contractone",
            },
            tableheader: [
                "Reference",
