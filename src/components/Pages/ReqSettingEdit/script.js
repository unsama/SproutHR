...
export default{
    created: function () {
        ...
        $(function() {
            $("#save").click(function () {
                var r = confirm("Are you sure update Job Positions");
                if (r)
                {
                    window.location.href = "../ReqSetting/"+self.$route.params.id;
                    self.submit();
                }
                else
                {
            ...
            self.btnlinks.discardbtnlink = "/recruitment/ReqPosition";
    ...
    data () {
        return {
            nextactivity: "Job Positions/News",
