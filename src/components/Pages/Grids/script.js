...
export default{
    ...
    data () {
        return {
            ...
            btnlinks: {
                 ...
                 secondbtnlink: "/attendance/AttTableHr"
    ...
    methods: {
        select3: function () {
            ...
            self.$http.post("/recruitment/empnext", {"counter": self.counter}).then(function (res) {
        ...
        select4: function () {
            ...
            self.$http.post("/recruitment/empback", {"counter": self.counter}).then(function (res) {
                self.employeenames = res.body.data;
                console.log(self.employeenames);
            },function(err){
                alert(err);
        ...
        select: function () {
            var self = this;
            self.$http.post("/recruitment/fetchEmployeeName", {"id": self.$route.params.id}).then(function (res) {
