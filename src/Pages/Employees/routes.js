        ...
        children: [
            { path: '', component: Employeeslayout,
                children: [
                    ...
                    { path: 'DuplicateContract/:id', component: DuplicateContract },
                    ...
                    { path: 'Badge/:id', component: Badge},
                    { path: 'contractSave/:id', component: ContractSave},
                    { path: 'EmpContract', component: EmpContract},
                    { path: 'contractone/:id', component: Contractone},
                    { path: 'ContractNew', component: ContractNew},
                    { path: 'Contracttwo', component: Contracttwo},
                    { path: 'DepNew/:id', component: DepNew},
                    ...
                    { path: 'TableEdit/:id', component: TableEdit },
                    { path: 'TableCreate', component: TableCreate },
                    { path: 'Tables/:id', component: Tables },
                    ...
                    { path: 'Gridtwotable', component: Gridtwotable },
                    { path: 'HrDeps/:id', component: HrDeps },
                    { path: 'HrDepscreate', component: HrDepscreate },
                    { path: 'HrDepsEdit/:id', component: HrDepsEdit },
                    { path: 'HrDuplicate/:id', component: HrDuplicate },
